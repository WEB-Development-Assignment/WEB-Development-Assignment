<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home(DoA_Keels).aspx.cs" Inherits="WEB_Assignment___Agriculture._Default" %>
...
<nav class="mynav">
 <ul>
    ...
    <li>
      <a href="Report_View.aspx">Report View</a>
    </li>
     <li>
